%% ¡header!
NNDatasetNormalize < ConcreteElement (dnorm, normalizer of a neural network data) transfroms neural network datasets.
...
%%% ¡prop!
Normalized_D (data, item) is the normalized neural network dataset.
%%%% ¡settings!
'NNDataset'
%%%% ¡calculate!
value = Dataset();
