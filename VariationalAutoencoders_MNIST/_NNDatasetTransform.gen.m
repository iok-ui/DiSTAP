%% ¡header!
NNDatasetTransform < ConcreteElement (dtran, transformer of a neural network data) transfroms neural network datasets.
...
%%% ¡prop!
D (data, item) is the combined neural network dataset.
%%%% ¡settings!
'NNDataset'

%%% ¡prop!
Transformed_D (data, item) is the transformed neural network dataset.
%%%% ¡settings!
'NNDataset'
%%%% ¡calculate!
value = Dataset();
