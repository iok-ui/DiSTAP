...
pipeline_folders = {
    'RamanSpectra'
    'VariationalAutoencoder2DCNN'
    'VariationalAutoencoderMLP'
...
rollcall = { ...
    ...
    '-neuralnetworks', ...
    '+pipelines', ...
    '+RamanSpectra*', '+VariationalAutoencoder2DCNN*', '+VariationalAutoencoderMLP*', '+VariationalAutoencoderRamanSpectra*', ...
    '+test*', ...
    '-sandbox' ...
    };
files_to_delete = { ...
