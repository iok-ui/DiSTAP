	...
	methods (Static) % inspection
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % NNDatasetNormalize.D
					prop_settings = 'NNDataset';
				case 10 % NNDatasetNormalize.NORMALIZED_D
					prop_settings = 'NNDataset';
				case 4 % NNDatasetNormalize.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 10 % NNDatasetNormalize.NORMALIZED_D
					prop_default = Format.getFormatDefault(8, NNDatasetNormalize.getPropSettings(prop));
				case 1 % NNDatasetNormalize.ELCLASS
					prop_default = 'NNDatasetCombine';
				case 2 % NNDatasetNormalize.NAME
					prop_default = 'Neural Network Dataset Combiner';
				case 3 % NNDatasetNormalize.DESCRIPTION
				...
				case 4 % NNDatasetNormalize.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNDatasetNormalize.getPropSettings(prop));
				case 5 % NNDatasetNormalize.ID
					prop_default = 'NNDatasetCombine ID';
				case 6 % NNDatasetNormalize.LABEL
					prop_default = 'NNDatasetCombine label';
				case 7 % NNDatasetNormalize.NOTES
