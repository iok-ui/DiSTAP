	...
	methods (Static) % inspection
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % NNDatasetTransform.D
					prop_settings = 'NNDataset';
				case 10 % NNDatasetTransform.TRANSFORMED_D
					prop_settings = 'NNDataset';
				case 4 % NNDatasetTransform.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 10 % NNDatasetTransform.TRANSFORMED_D
					prop_default = Format.getFormatDefault(8, NNDatasetTransform.getPropSettings(prop));
				case 1 % NNDatasetTransform.ELCLASS
					prop_default = 'NNDatasetCombine';
				case 2 % NNDatasetTransform.NAME
					prop_default = 'Neural Network Dataset Combiner';
				case 3 % NNDatasetTransform.DESCRIPTION
				...
				case 4 % NNDatasetTransform.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNDatasetTransform.getPropSettings(prop));
				case 5 % NNDatasetTransform.ID
					prop_default = 'NNDatasetCombine ID';
				case 6 % NNDatasetTransform.LABEL
					prop_default = 'NNDatasetCombine label';
				case 7 % NNDatasetTransform.NOTES
