classdef NNDataPoint_Spectrum < NNDataPoint
	...
	methods (Static) % inspection
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 11 % NNDataPoint_Spectrum.SP
					prop_settings = Format.getFormatSettings(12);
				case 12 % NNDataPoint_Spectrum.WL
					prop_settings = Format.getFormatSettings(12);
				case 13 % NNDataPoint_Spectrum.WL_START
					prop_settings = Format.getFormatSettings(11);
				case 14 % NNDataPoint_Spectrum.WL_END
					prop_settings = Format.getFormatSettings(11);
				case 15 % NNDataPoint_Spectrum.TARGET_CLASS
					prop_settings = Format.getFormatSettings(3);
				case 4 % NNDataPoint_Spectrum.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % NNDataPoint_Spectrum.ELCLASS
					prop_default = 'NNDataPoint_Spectrum';
				case 2 % NNDataPoint_Spectrum.NAME
					prop_default = 'Neural Network Data Point for Classification with a Graph';
				case 3 % NNDataPoint_Spectrum.DESCRIPTION
				...
				case 5 % NNDataPoint_Spectrum.ID
					prop_default = 'NNDataPoint_Spectrum ID';
				case 6 % NNDataPoint_Spectrum.LABEL
					prop_default = 'NNDataPoint_Spectrum label';
				case 7 % NNDataPoint_Spectrum.NOTES
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(dp, prop, varargin)
			...
			switch prop
				case 9 % NNDataPoint_Spectrum.INPUT
				...
				case 10 % NNDataPoint_Spectrum.TARGET
