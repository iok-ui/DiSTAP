classdef NNAutoencoder < NNBase
	%NNAutoencoder transfroms neural network datasets.
	...
	methods % constructor
		function nnvae = NNAutoencoder(varargin)
			%NNAutoencoder() creates a normalizer of a neural network data.
			%
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% Note that the Element.GETBUILD(NNVAE) and Element.GETBUILD('NNAutoencoder')
		...
		function nnvae_class = getClass()
			...
			%
			% Note that the Element.GETCLASS(NNVAE) and Element.GETCLASS('NNAutoencoder')
			%  are less computationally efficient.
			
			nnvae_class = 'NNAutoencoder';
		end
		function subclass_list = getSubclasses()
			...
			%
			% Note that the Element.GETSUBCLASSES(NNVAE) and Element.GETSUBCLASSES('NNAutoencoder')
			%  are less computationally efficient.
			%
			% See also subclasses.
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = NNAutoencoder.GETPROPS() returns the property list of normalizer of a neural network data
			%  as a row vector.
			%
			...
			%
			% Note that the Element.GETPROPS(NNVAE) and Element.GETPROPS('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = NNAutoencoder.GETPROPNUMBER() returns the property number of normalizer of a neural network data.
			%
			% N = NNAutoencoder.GETPROPNUMBER(CATEGORY) returns the property number of normalizer of a neural network data
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
			...
			%
			% Note that the Element.GETPROPNUMBER(NNVAE) and Element.GETPROPNUMBER('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function check_out = existsProp(prop)
			...
			%   Error id: [BRAPH2:NNAutoencoder:WrongInput]
			%
			% Note that the Element.EXISTSPROP(NNVAE) and Element.EXISTSPROP('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function check_out = existsTag(tag)
			...
			%   Error id: [BRAPH2:NNAutoencoder:WrongInput]
			%
			% Note that the Element.EXISTSTAG(NNVAE) and Element.EXISTSTAG('NNAutoencoder')
			%  are less computationally efficient.
			%
			% See also getProps, existsTag.
		...
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = NNVAE.GETPROPPROP(NNAutoencoder, POINTER) returns property number of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPPROP(NNVAE) and Element.GETPROPPROP('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = NNVAE.GETPROPTAG(NNAutoencoder, POINTER) returns tag of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPTAG(NNVAE) and Element.GETPROPTAG('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = NNVAE.GETPROPCATEGORY(NNAutoencoder, POINTER) returns category of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPCATEGORY(NNVAE) and Element.GETPROPCATEGORY('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = NNVAE.GETPROPFORMAT(NNAutoencoder, POINTER) returns format of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPFORMAT(NNVAE) and Element.GETPROPFORMAT('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = NNVAE.GETPROPDESCRIPTION(NNAutoencoder, POINTER) returns description of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPDESCRIPTION(NNVAE) and Element.GETPROPDESCRIPTION('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = NNVAE.GETPROPSETTINGS(NNAutoencoder, POINTER) returns settings of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPSETTINGS(NNVAE) and Element.GETPROPSETTINGS('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_default = getPropDefault(pointer)
			...
			%  DEFAULT = NNVAE.GETPROPDEFAULT(NNAutoencoder, POINTER) returns the default value of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPDEFAULT(NNVAE) and Element.GETPROPDEFAULT('NNAutoencoder')
			%  are less computationally efficient.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			...
			%  DEFAULT = NNVAE.GETPROPDEFAULTCONDITIONED(NNAutoencoder, POINTER) returns the conditioned default value of POINTER of NNAutoencoder.
			%
			% Note that the Element.GETPROPDEFAULTCONDITIONED(NNVAE) and Element.GETPROPDEFAULTCONDITIONED('NNAutoencoder')
			%  are less computationally efficient.
			%
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = NNVAE.CHECKPROP(NNAutoencoder, PROP, VALUE) checks VALUE format for PROP of NNAutoencoder.
			% 
			...
			%   Error id: BRAPH2:NNAutoencoder:WrongInput
			%  NNVAE.CHECKPROP(NNAutoencoder, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNAutoencoder.
			%   Error id: BRAPH2:NNAutoencoder:WrongInput]
			% 
			% Note that the Element.CHECKPROP(NNVAE) and Element.CHECKPROP('NNAutoencoder')
			%  are less computationally efficient.
			%
