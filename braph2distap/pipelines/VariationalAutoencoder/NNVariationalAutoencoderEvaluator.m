classdef NNVariationalAutoencoderEvaluator < NNEvaluator
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNVariationalAutoencoderEvaluator'  'NNVariationalAutoencoderEvaluator_Image'  'NNVariationalAutoencoderEvaluator_RS' }; %CET: Computational Efficiency Trick
		end
