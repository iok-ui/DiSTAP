classdef NNVariationalAutoencoderEvaluator_RS < NNVariationalAutoencoderEvaluator
	...
	%  <strong>13</strong> <strong>IDX_LABEL_OF_INTEREST</strong> 	IDX_LABEL_OF_INTEREST (parameter, scalar) indentifies importance peaks.
	%  <strong>14</strong> <strong>PEAK_IDENTIFICATION</strong> 	PEAK_IDENTIFICATION (result, rvector) indentifies importance peaks.
	...
	properties (Constant) % properties
		IDX_LABEL_OF_INTEREST = 13; %CET: Computational Efficiency Trick
		IDX_LABEL_OF_INTEREST_TAG = 'IDX_LABEL_OF_INTEREST';
		IDX_LABEL_OF_INTEREST_CATEGORY = 3;
		IDX_LABEL_OF_INTEREST_FORMAT = 11;
		
		PEAK_IDENTIFICATION = 14; %CET: Computational Efficiency Trick
		PEAK_IDENTIFICATION_TAG = 'PEAK_IDENTIFICATION';
		PEAK_IDENTIFICATION_CATEGORY = 5;
		PEAK_IDENTIFICATION_FORMAT = 12;
		
		ZERO_CROSSING_P2N = 15; %CET: Computational Efficiency Trick
		ZERO_CROSSING_P2N_TAG = 'ZERO_CROSSING_P2N';
		ZERO_CROSSING_P2N_CATEGORY = 6;
		ZERO_CROSSING_P2N_FORMAT = 12;
		
		ZERO_CROSSING_N2P = 16; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 13 % NNVariationalAutoencoderEvaluator_RS.IDX_LABEL_OF_INTEREST
					prop_settings = Format.getFormatSettings(11);
				case 14 % NNVariationalAutoencoderEvaluator_RS.PEAK_IDENTIFICATION
					prop_settings = Format.getFormatSettings(12);
				case 15 % NNVariationalAutoencoderEvaluator_RS.ZERO_CROSSING_P2N
					prop_settings = Format.getFormatSettings(12);
				case 16 % NNVariationalAutoencoderEvaluator_RS.ZERO_CROSSING_N2P
					prop_settings = Format.getFormatSettings(12);
