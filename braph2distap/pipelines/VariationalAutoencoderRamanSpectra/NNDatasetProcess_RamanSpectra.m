classdef NNDatasetProcess_RamanSpectra < NNDatasetProcess
	...
	properties (Constant) % properties
		TARGETS_TO_REMOVE = NNDatasetProcess.getPropNumber() + 1;
		...
		NORMALIZATION_RULE = NNDatasetProcess.getPropNumber() + 6;
	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNDatasetProcess_RamanSpectra.EXTRACT_LABELS
					prop_description = 'EXTRACT_LABELS (query, stringlist) extracts the labels from the specified IDX files.';
