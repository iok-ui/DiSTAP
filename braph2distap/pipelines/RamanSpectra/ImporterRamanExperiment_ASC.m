classdef ImporterRamanExperiment_ASC < Importer
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the importer of Raman experiment from ASC.
			%
			% BUILD = ImporterRamanExperiment_ASC.GETBUILD() returns the build of 'ImporterRamanExperiment_ASC'.
			%
			% Alternative forms to call this method are:
			%  BUILD = IM.GETBUILD() returns the build of the importer of Raman experiment from ASC IM.
			%  BUILD = Element.GETBUILD(IM) returns the build of 'IM'.
			%  BUILD = Element.GETBUILD('ImporterRamanExperiment_ASC') returns the build of 'ImporterRamanExperiment_ASC'.
			%
			% Note that the Element.GETBUILD(IM) and Element.GETBUILD('ImporterRamanExperiment_ASC')
