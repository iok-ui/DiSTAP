classdef PanelPropRVectorDate < PanelProp
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the panel property date.
			%
			% BUILD = PanelPropRVectorDate.GETBUILD() returns the build of 'PanelPropRVectorDate'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property date PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('PanelPropRVectorDate') returns the build of 'PanelPropRVectorDate'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('PanelPropRVectorDate')
