classdef NNEvaluator < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNEvaluator'  'NNVariationalAutoencoderEvaluator'  'NNVariationalAutoencoderEvaluator_Image'  'NNVariationalAutoencoderEvaluator_RS' }; %CET: Computational Efficiency Trick
		end
