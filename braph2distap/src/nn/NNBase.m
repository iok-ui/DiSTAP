classdef NNBase < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNBase'  'NNAutoencoder'  'NNVariationalAutoencoder'  'NNVariationalAutoencoder2DCNN'  'NNVariationalAutoencoderMLP' }; %CET: Computational Efficiency Trick
		end
